...
@ManagedBean
@ViewScoped
public class ConceptoTesoreriaBean extends GenericBean implements Serializable {
    ...
    private final String MODULO = "CJ";
    ...
    public List<Concepto> complete(String query) {
        try {
            ...
            lista = conceptoRN.getListaByBusqueda(MODULO, codTipo, query, false, 10);
            return lista;
