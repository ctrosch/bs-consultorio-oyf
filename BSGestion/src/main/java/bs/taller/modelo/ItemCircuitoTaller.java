...
@Entity
@Table(name = "tl_circuito_item")
@EntityListeners(AuditoriaListener.class)
@Inheritance(strategy = InheritanceType.SINGLE_TABLE)
@DiscriminatorColumn(name = "MODULO", discriminatorType = DiscriminatorType.STRING, length = 2)
@IdClass(ItemCircuitoTallerPK.class)
public class ItemCircuitoTaller implements Serializable, IAuditableEntity {
    ...
    public ItemCircuitoTaller() {

        this.auditoria = new Auditoria();

    }

    public ItemCircuitoTaller(String cirapl, String circom, String modulo, String codcom) {
        this.cirapl = cirapl;
        this.circom = circom;
        this.modulo = modulo;
        this.codcom = codcom;
    ...
    public boolean equals(Object obj) {
        ...
        final ItemCircuitoTaller other = (ItemCircuitoTaller) obj;
    ...
    public String toString() {
        return "ItemCircuitoService{" + "cirapl=" + cirapl + ", circom=" + circom + ", modulo=" + modulo + ", codcom=" + codcom + '}';
    }
}
