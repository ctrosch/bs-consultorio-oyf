...
public class NumeroToLetras {
    ...
    public NumeroToLetras(){
            numero = 0;
            flag=0;
    }
    public NumeroToLetras(int n){
            numero = n;
            flag=0;
    }
    ...
    public String convertirLetras(BigDecimal numero){
        
        int parteEntera = numero.intValue();
        BigDecimal parteEntreraD = new BigDecimal(parteEntera);
        BigDecimal parteDecimalD = numero.add(parteEntreraD.negate()).setScale(2,RoundingMode.HALF_UP).multiply(new BigDecimal("100"));
        int parteDecimal = parteDecimalD.intValue();
        num_letras = decmillon(parteEntera)+(parteDecimal>0?" con "+decmillon(parteDecimal)+" centavos":"");
        return num_letras;
    }
}
