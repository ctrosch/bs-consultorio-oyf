...
public class ZonaDAO extends BaseDAO {
    ...
    public List<Zona> getLista(boolean mostrarDebaja) {
        ...
        try {
            String sQuery = "SELECT e FROM Zona e "
                    + "WHERE 1=1"
    ...
    public List<Zona> getListaByBusqueda(Map<String, String> filtro, String txtBusqueda, boolean mostrarDebaja, int cantMax) {
        ...
        try {
            ...
            e.printStackTrace();
            log.log(Level.SEVERE, "getZonaByBusqueda", e.getMessage());
            return new ArrayList<Zona>();
        }
