 ...
 */
@Entity
@Table(name="st_rubro09")
@EntityListeners(AuditoriaListener.class)
@IdClass(RubroPK.class)
public class Rubro09 implements Serializable, IAuditableEntity{
    ...
    public Rubro09(String codigo, String tippro) {
        this.codigo = codigo;
        this.tippro = tippro;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final Rubro09 other = (Rubro09) obj;
