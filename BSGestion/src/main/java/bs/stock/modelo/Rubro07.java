 ...
 */
@Entity
@Table(name="st_rubro07")
@EntityListeners(AuditoriaListener.class)
@IdClass(RubroPK.class)
public class Rubro07 implements Serializable, IAuditableEntity{
    ...
    public Rubro07(String codigo, String tippro) {
        this.codigo = codigo;
        this.tippro = tippro;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final Rubro07 other = (Rubro07) obj;
