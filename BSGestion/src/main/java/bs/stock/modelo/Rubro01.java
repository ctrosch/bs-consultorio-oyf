 ...
 */
@Entity
@Table(name="st_rubro01")
@EntityListeners(AuditoriaListener.class)
@IdClass(RubroPK.class)
public class Rubro01 implements Serializable, IAuditableEntity{
    ...
    public Rubro01(String codigo, String tippro) {
        this.codigo = codigo;
        this.tippro = tippro;
        this.auditoria = new Auditoria();
    }
    ...
    public boolean equals(Object obj) {
        ...
        final Rubro01 other = (Rubro01) obj;
