 ...
 */
@Entity
@Table(name = "st_rubro03")
@EntityListeners(AuditoriaListener.class)
@IdClass(RubroPK.class)
public class Rubro03 implements Serializable, IAuditableEntity {
    ...
    public Rubro03(String codigo, String tippro) {
        this.codigo = codigo;
        this.tippro = tippro;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final Rubro03 other = (Rubro03) obj;
