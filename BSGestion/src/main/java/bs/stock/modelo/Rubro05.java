 ...
 */
@Entity
@Table(name="st_rubro05")
@EntityListeners(AuditoriaListener.class)
@IdClass(RubroPK.class)
public class Rubro05 implements Serializable, IAuditableEntity{
    ...
    public Rubro05(String codigo, String tippro) {
        this.codigo = codigo;
        this.tippro = tippro;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final Rubro05 other = (Rubro05) obj;
