 ...
 */
@Entity
@Table(name="st_rubro08")
@EntityListeners(AuditoriaListener.class)
@IdClass(RubroPK.class)
public class Rubro08 implements Serializable, IAuditableEntity{
    ...
    public Rubro08(String codigo, String tippro) {
        this.codigo = codigo;
        this.tippro = tippro;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final Rubro08 other = (Rubro08) obj;
