 ...
 */
@Entity
@Table(name="st_rubro06")
@EntityListeners(AuditoriaListener.class)
@IdClass(RubroPK.class)
public class Rubro06 implements Serializable, IAuditableEntity{
    ...
    public Rubro06(String codigo, String tippro) {
        this.codigo = codigo;
        this.tippro = tippro;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final Rubro06 other = (Rubro06) obj;
