...
@ManagedBean
@ViewScoped
public class IvaDigitalBean extends InformeBase implements Serializable {
    ...
    public void generarArchivos() {
        try {
            ...
            generarTXTAlicuotasVenta();
            generarTXTComprobanteCompra();
            generarTXTAlicuotasCompra();
    ...
    public void generarTXTComprobanteVenta() {
        ...
        try {
            ...
            //File archivo=new File(aplicacionBean.getParametro().getPathCarpetaTemporales()+"LIBRO_IVA_DIGITAL_VENTAS_CBTE_"+cal1.get(Calendar.YEAR)+"_"+(cal1.get(Calendar.MONTH)+1)+".txt");
            File archivo = new File(aplicacionBean.getParametro().getPathCarpetaTemporales() + "LIBRO_IVA_DIGITAL_VENTAS_CBTE.txt");
...
//                }
                ...
                linea = sdf.format(m.getFechaMovimiento())
                        ...
                        + sUtil.right("000000000000000", 15) //Percepción a no cat - (castigo) cuando no presentan documentación para saber que percepcion aplicar
...
//                System.out.print(linea);
            ...
            ArchivoDescargable a = new ArchivoDescargable("Comprobantes Venta", null, file);
            archivos.add(a);
    ...
    public void generarTXTAlicuotasVenta() {
        ...
        try {
            ...
            //Crear un objeto File se encarga de crear o abrir acceso a un archivo que se especifica en su constructor
            //File archivo=new File(aplicacionBean.getParametro().getPathCarpetaTemporales()+"LIBRO_IVA_DIGITAL_VENTAS_ALICUOTAS_"+cal1.get(Calendar.YEAR)+"_"+(cal1.get(Calendar.MONTH)+1)+".txt");
            File archivo = new File(aplicacionBean.getParametro().getPathCarpetaTemporales() + "LIBRO_IVA_DIGITAL_VENTAS_ALICUOTAS.txt");
    ...
    public void generarTXTComprobanteCompra() {
        ...
        try {
            ...
            //Crear un objeto File se encarga de crear o abrir acceso a un archivo que se especifica en su constructor
            //File archivo=new File(aplicacionBean.getParametro().getPathCarpetaTemporales()+"LIBRO_IVA_DIGITAL_COMPRAS_CBTE_"+cal1.get(Calendar.YEAR)+"_"+(cal1.get(Calendar.MONTH)+1)+".txt");
            File archivo = new File(aplicacionBean.getParametro().getPathCarpetaTemporales() + "LIBRO_IVA_DIGITAL_COMPRAS_CBTE.txt");
...
//                if (m.getComprobante().getCodigo().equals("DespachoImportacion")) {
...
//                }
                ...
                linea = sdf.format(m.getFechaMovimiento())
                        ...
                        + sUtil.right("0000000000000000" + nroDespachoImportacion, 16) //Despacho de importación VER
                        + sUtil.right("00" + m.getTipoDocumento().getCodigo(), 2)
                        + sUtil.right("00000000000000000000" + m.getNrodoc(), 20)
                        + sUtil.left(m.getRazonSocial() + "                              ", 30)
                        + sUtil.right("000000000000000" + importeTotal.toString(), 15) //Importe total de la operación
                        ...
                        + sUtil.right("000000000000000", 15) //Imp. Percepcion de impuestos munic
    ...
    public void generarTXTAlicuotasCompra() {
        ...
        try {
            ...
            //Crear un objeto File se encarga de crear o abrir acceso a un archivo que se especifica en su constructor
            //File archivo=new File(aplicacionBean.getParametro().getPathCarpetaTemporales()+"LIBRO_IVA_DIGITAL_COMPRAS_ALICUOTAS_"+cal1.get(Calendar.YEAR)+"_"+(cal1.get(Calendar.MONTH)+1)+".txt");
            File archivo = new File(aplicacionBean.getParametro().getPathCarpetaTemporales() + "LIBRO_IVA_DIGITAL_COMPRAS_ALICUOTAS.txt");
