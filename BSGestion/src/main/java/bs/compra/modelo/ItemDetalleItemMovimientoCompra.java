 ...
 */
@Entity
@Table(name = "co_movimiento_item_detalle")
@EntityListeners(AuditoriaListener.class)
public class ItemDetalleItemMovimientoCompra implements Serializable, ItemDetalleModelo {
    ...
    private ItemMovimientoCompra itemProducto;
    ...
    public ItemDetalleItemMovimientoCompra() {
    ...
    public ItemDetalleItemMovimientoCompra(Producto producto) {
    ...
    public boolean equals(Object obj) {
        ...
        final ItemDetalleItemMovimientoCompra other = (ItemDetalleItemMovimientoCompra) obj;
    ...
    public String toString() {
        return "DetalleItemMovimientoCompra{" + "id=" + this.id + '}';
    }
}
