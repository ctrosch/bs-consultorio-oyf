 ...
 */
@Entity
@Table(name = "fc_movimiento_item_kit_detalle")
@EntityListeners(AuditoriaListener.class)
public class ItemMovimientoFacturacionKitDetalle implements IAuditableEntity, Serializable, ItemDetalleModelo {
    ...
    private ItemMovimientoFacturacionKit itemKit;
    ...
    public ItemMovimientoFacturacionKitDetalle() {
    ...
    public ItemMovimientoFacturacionKitDetalle(Producto producto) {
    ...
    public ItemMovimientoFacturacionKit getItemKit() {
        return itemKit;
    }

    public void setItemKit(ItemMovimientoFacturacionKit itemKit) {
    ...
    public boolean equals(Object obj) {
        ...
        final ItemMovimientoFacturacionKitDetalle other = (ItemMovimientoFacturacionKitDetalle) obj;
    ...
    public String toString() {
        return "ItemMovimientoFacturacionKitDetalle{" + "id=" + this.id + '}';
    }
}
