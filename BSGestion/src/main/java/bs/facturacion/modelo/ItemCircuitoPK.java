...
public class ItemCircuitoPK implements Serializable {
    ...
    public ItemCircuitoPK() {
    }

    public ItemCircuitoPK(String fctciiCirapl, String fctciiCircom, String fctciiModulo, String fctciiCodcom) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ItemCircuitoPK)) {
            return false;
        }
        ItemCircuitoPK other = (ItemCircuitoPK) object;
