...
@ManagedBean
@ViewScoped
public class PendienteFacturacionProducto extends InformeBase implements Serializable{
     ...
     */
    public PendienteFacturacionProducto() {
    }
    ...
    public void cargarParametros() throws ExcepcionGeneralSistema {
        ...
        nombreArchivo = "PendienteProducto_"+JsfUtil.getCadenaAlfanumAleatoria(6);
        reporte = reporteRN.getReporte(codigoReporte);
        //pathReporte = "facturacion/informe/PENPRD.jasper";
