 ...
 */
@Entity
@Table(name = "mt_movimiento_actividad")
@EntityListeners(AuditoriaListener.class)
public class ItemMovimientoMantenimientoActividad implements Serializable, IAuditableEntity {
    ...
    @Column(name = "ID_SAC", nullable = false)
    private int codigoSubactividad;

    @Size(max = 120)
    @Column(name = "DES_SA", nullable = false)
    private String desccripcionSubactividad;

    @Size(max = 1)
    @Column(name = "OBLIGA", nullable = false)
    private String obligatorio;

    @Column(name = "NORDSA", nullable = false)
    private int nroOrdenSubactividad;
...
//    private List<AplicacionCuentaCorrienteEducacion> itemsCuentaCorriente;
    ...
    public ItemMovimientoMantenimientoActividad() {
...
//        itemsCuentaCorriente = new ArrayList<AplicacionCuentaCorrienteEducacion>();
    ...
    public int getCodigoSubactividad() {
        return codigoSubactividad;
    }

    public void setCodigoSubactividad(int codigoSubactividad) {
        this.codigoSubactividad = codigoSubactividad;
    }

    public String getDesccripcionSubactividad() {
        return desccripcionSubactividad;
    }

    public void setDesccripcionSubactividad(String desccripcionSubactividad) {
        this.desccripcionSubactividad = desccripcionSubactividad;
    }
    ...
    public int getNroOrdenSubactividad() {
        return nroOrdenSubactividad;
    }

    public void setNroOrdenSubactividad(int nroOrdenSubactividad) {
        this.nroOrdenSubactividad = nroOrdenSubactividad;
    }
...
//    }
    ...
    public boolean equals(Object obj) {
        ...
        final ItemMovimientoMantenimientoActividad other = (ItemMovimientoMantenimientoActividad) obj;
