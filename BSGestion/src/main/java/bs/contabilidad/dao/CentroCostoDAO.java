...
public class CentroCostoDAO extends BaseDAO {
    ...
    public CentroCosto getCentroCosto(String id) {
        return getObjeto(CentroCosto.class, id);
    }

    public List<CentroCosto> getListaByBusqueda(Map<String, String> filtro, String txtBusqueda, boolean mostrarDeBaja, int cantMax) {
        try {

            String sQuery = "SELECT e FROM CentroCosto e "
