...
@ManagedBean
@ViewScoped
public class CentroCostoBean extends GenericBean implements Serializable {
        ...
        try {
            if (!beanIniciado) {
                ...
                if (codigo != null && !codigo.isEmpty()) {
                    seleccionar(centroCostoRN.getCentroCosto(codigo));
                }
    ...
    public void buscar() {
        ...
        lista = centroCostoRN.getListaByBusqueda(filtro, txtBusqueda, mostrarDebaja, cantidadRegistros);
        modoVista = "B";
    }
