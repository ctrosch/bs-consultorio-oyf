 ...
 */
@Entity
@Table(name = "sg_usuario_sucursal")
public class ItemSucursalUsuario implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        final ItemSucursalUsuario other = (ItemSucursalUsuario) obj;
