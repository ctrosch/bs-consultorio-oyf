 ...
 */
@Entity
@Table(name = "ed_movimiento_item")
@EntityListeners(AuditoriaListener.class)
public class ItemMovimientoEducacion implements Serializable, IAuditableEntity {
    ...
    private MovimientoEducacion movimiento;
    ...
    @Column(name = "PREORI", precision = 15, scale = 4)
...
//    private List<AplicacionCuentaCorrienteEducacion> itemsCuentaCorriente;
    ...
    public ItemMovimientoEducacion() {
...
//    }
    ...
    public boolean equals(Object obj) {
        ...
        final ItemMovimientoEducacion other = (ItemMovimientoEducacion) obj;
