...
@ManagedBean
@ViewScoped
public class CompraRankingProducto extends InformeBase implements Serializable{
    ...
    public void cargarParametros() throws ExcepcionGeneralSistema {
        ...
        nombreArchivo = "COM_RANKING_PRODUCTO";
        reporte = reporteRN.getReporte(codigoReporte);
        //pathReporte = "proveedor/informe/estadistica/COM_RANKING_PRODUCTO.jasper";
