...
@ManagedBean
@ViewScoped
public class CompraRankingProveedor extends InformeBase implements Serializable{
    ...
    public void cargarParametros() throws ExcepcionGeneralSistema {
        ...
        nombreArchivo = "COM_RANKING_PROVEEDOR";
        reporte = reporteRN.getReporte(codigoReporte);
        //pathReporte = "proveedor/informe/estadistica/COM_RANKING_PROVEEDOR.jasper";
