...
@ManagedBean
@ViewScoped
public class CompraComprobanteProveedorProducto extends InformeBase implements Serializable {
     ...
     */
    public CompraComprobanteProveedorProducto() {
    }
    ...
    public void cargarParametros() throws ExcepcionGeneralSistema {
        ...
        nombreArchivo = "COM_COMPROBANTE_PRODUCTO_CLIENTE";
        reporte = reporteRN.getReporte(codigoReporte);
        //pathReporte = "proveedor/informe/estadistica/COM_COMPROBANTE_PRODUCTO_CLIENTE.jasper";
