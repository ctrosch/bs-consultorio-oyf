...
@ManagedBean
@ViewScoped
public class CompraProvincia extends InformeBase implements Serializable{
    ...
    public void cargarParametros() throws ExcepcionGeneralSistema {
        ...
        nombreArchivo = "COM_PROVINCIA";
        reporte = reporteRN.getReporte(codigoReporte);
        //pathReporte = "proveedor/informe/estadistica/COM_PROVINCIA.jasper";
