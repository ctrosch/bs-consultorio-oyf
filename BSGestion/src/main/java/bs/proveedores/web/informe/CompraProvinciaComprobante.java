...
@ManagedBean
@ViewScoped
public class CompraProvinciaComprobante extends InformeBase implements Serializable{
     ...
     */
    public CompraProvinciaComprobante() {
    }
    ...
    public void cargarParametros() throws ExcepcionGeneralSistema {
        ...
        nombreArchivo = "COM_PROVINCIA_COMPROBANTE";
        reporte = reporteRN.getReporte(codigoReporte);
        //pathReporte = "proveedor/informe/estadistica/COM_PROVINCIA_COMPROBANTE.jasper";
