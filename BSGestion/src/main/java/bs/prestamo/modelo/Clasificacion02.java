 ...
 */
@Entity
@Table(name = "pr_clasificacion_02")
@XmlRootElement
public class Clasificacion02 implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        final Clasificacion02 other = (Clasificacion02) obj;
    ...
    public String toString() {
        return "Clasificacion02{" + "codigo=" + codigo + '}';
    }
