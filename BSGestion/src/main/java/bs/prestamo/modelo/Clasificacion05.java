 ...
 */
@Entity
@Table(name = "pr_clasificacion_05")
@XmlRootElement
public class Clasificacion05 implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        final Clasificacion05 other = (Clasificacion05) obj;
    ...
    public String toString() {
        return "Clasificacion05{" + "codigo=" + codigo + '}';
    }
