 ...
 */
@Entity
@Table(name = "pr_clasificacion_04")
@XmlRootElement
public class Clasificacion04 implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        final Clasificacion04 other = (Clasificacion04) obj;
    ...
    public String toString() {
        return "Clasificacion04{" + "codigo=" + codigo + '}';
    }
