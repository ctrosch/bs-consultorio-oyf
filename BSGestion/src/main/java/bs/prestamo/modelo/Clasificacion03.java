 ...
 */
@Entity
@Table(name = "pr_clasificacion_03")
@XmlRootElement
public class Clasificacion03 implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        final Clasificacion03 other = (Clasificacion03) obj;
    ...
    public String toString() {
        return "Clasificacion03{" + "codigo=" + codigo + '}';
    }
