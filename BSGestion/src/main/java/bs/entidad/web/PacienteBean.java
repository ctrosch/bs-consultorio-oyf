...
@ManagedBean
@ViewScoped
public class PacienteBean extends GenericBean implements Serializable {
...
//            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, null, ex);
    ...
    public void cargarFiltroBusqueda() {
        ...
        // Filtramos solo pacientes por unidad de negocio a la que pertenece el usuario
    ...
    public void procesarLocalidadFactura() {

        if (entidad != null && entidad.getLocalidadFactura() != null) {

            entidad.setProvinciaFactura(entidad.getLocalidadFactura().getProvincia());
        }
    }

    public void borrarAlergia() {
        if (entidad.getAlergia().equals("N")) {
            entidad.setDetalleAlergia("");
        }
    }

    public void borrarTratamiento() {
        if (entidad.getTratamientoMedico().equals("N")) {
            entidad.setDetalleTratamientoMedico("");
        }
    }
    ...
    public void procesarLocalidadDlgFactura() {

        if (entidad != null && localidadBean.getLocalidad() != null) {

            entidad.setLocalidadFactura(localidadBean.getLocalidad());
            entidad.setProvinciaFactura(entidad.getLocalidadFactura().getProvincia());
        }
    }
    ...
    public void nuevoItemObraSocial() {

        entidadRN.nuevoItemObraSocial(entidad);
    }

    public void eliminarItemObraSocial(EntidadObraSocial itemObraSocial) {

        try {
            entidadRN.eliminarItemObraSocial(entidad, itemObraSocial);
            JsfUtil.addWarningMessage("Se ha borrado el item");
        } catch (Exception ex) {
            JsfUtil.addErrorMessage("Error " + ex);
        }
