...
@ManagedBean
@ViewScoped
public class ProfesionalMedicoBean extends GenericBean implements Serializable {
    ...
    public void iniciarVariables() {
        ...
        try {
            ...
            JsfUtil.addErrorMessage("Error al iniciar el bean " + this.getClass().getName() + " - " + ex);
        }
    }
...
//            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, null, ex);
    ...
    public void cargarFiltroBusqueda() {
        ...
        // Filtramos solo médicos por unidad de negocio a la que pertenece el usuario
