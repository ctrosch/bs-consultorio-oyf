...
//            String dllDir = "C:\\Program Files\\PyAfipWs\\";
//            File folder = new File( dllDir );
//
//            System.load(dllDir + "wsaa.dll");
//
//            try {
//                ActiveXComponent example = new ActiveXComponent("WSAA");
//            } catch (Exception e) {
...
//                                new Variant("wsfe"),
//                                new Variant("C:\\Users\\Claudio\\Documents\\NetBeansProjects\\FacturaElectroticaJava\\src\\facturaelectroticajava\\PRUEBA.crt"),
//                                new Variant("C:\\Users\\Claudio\\Documents\\NetBeansProjects\\FacturaElectroticaJava\\src\\facturaelectroticajava\\privada.key"),
//                                new Variant(wsdl));
