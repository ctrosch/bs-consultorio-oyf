...
@ManagedBean
@ViewScoped
public class VentaProvincia extends InformeBase implements Serializable{
    ...
    public void cargarParametros() throws ExcepcionGeneralSistema {
        ...
        nombreArchivo = "VTA_PROVINCIA";
        reporte = reporteRN.getReporte(codigoReporte);
        //pathReporte = "venta/informe/estadistica/VTA_PROVINCIA.jasper";
