...
@ManagedBean
@ViewScoped
public class VentaRankingCliente extends InformeBase implements Serializable{
    ...
    public void cargarParametros() throws ExcepcionGeneralSistema {
        ...
        nombreArchivo = "RANKING_CLIENTE";
        reporte = reporteRN.getReporte(codigoReporte);
        //pathReporte = "venta/informe/estadistica/VTA_RANKING_CLIENTE.jasper";
