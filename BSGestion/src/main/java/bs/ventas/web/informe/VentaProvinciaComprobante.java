...
@ManagedBean
@ViewScoped
public class VentaProvinciaComprobante extends InformeBase implements Serializable{
     ...
     */
    public VentaProvinciaComprobante() {
    }
    ...
    public void cargarParametros() throws ExcepcionGeneralSistema {
        ...
        nombreArchivo = "VTA_PROVINCIA_COMPROBANTE";
        reporte = reporteRN.getReporte(codigoReporte);
        //pathReporte = "venta/informe/estadistica/VTA_PROVINCIA_COMPROBANTE.jasper";
