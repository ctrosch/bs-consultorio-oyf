...
@ManagedBean
@ViewScoped
public class VentaClienteProducto extends InformeBase implements Serializable{
    ...
    public void cargarParametros() throws ExcepcionGeneralSistema {
        ...
        nombreArchivo = "VTA_PRODUCTO_CLIENTE";
        reporte = reporteRN.getReporte(codigoReporte);
        //pathReporte = "venta/informe/estadistica/VTA_PRODUCTO_CLIENTE.jasper";
