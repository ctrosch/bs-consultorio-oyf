 ...
 */
@Stateless
public class CobradorDAO extends BaseDAO {

    public List<Cobrador> getListaByBusqueda(String txtBusqueda, boolean mostrarDebaja, int cantMax) {

        try {
            String sQuery = "SELECT e FROM Cobrador e "
                    + "WHERE 1=1 "
