...
public class CondicionPagoVentaDAO extends BaseDAO {
    ...
    public List<CondicionDePagoVenta> getListaByBusquedaByImputacion(String imputaCuentaCorriente, boolean mostrarDebaja, int cantMax) {
